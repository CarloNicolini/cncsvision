...
%    8a. Spool raw data to file while at the same time request
%        and display real-time 3D data.
%    8b. Stop spooling after 2 sec! This simulates the use of an 
%        external trigger that switches off the spooling. 
...
while(~SpoolComplete)
  ...
  %Here we simulate that the data buffering is stopped by an external trigger
  if(toc>2)
    fprintf('Stopping buffering after 2 sec')
