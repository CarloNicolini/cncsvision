...
%  NDI_INCL  = '-I"C:\Program Files\NDIoapi\ndlib\include"';
  NDI_INCL  = '-I"C:\PROGRA~1\NDIoapi\ndlib\include"';
  NDI_LIB   = 'C:\PROGRA~1\NDIoapi\ndlib\msvc\oapi.lib';
  PLATFORM  = '-DPLATFORM_X86';
  OPTO_UTIL = 'optoUtil.obj';
  echo on
  mex('-c',NDI_INCL,'optoUtil.c',NDI_LIB,PLATFORM)
  mex(NDI_INCL,'optotrak.c',NDI_LIB,OPTO_UTIL,PLATFORM)
  echo off
