...
#include "Optotrak2.h"
#include "LatestCalibrationBrown.h"
...
double mirrorYaw,mirrorPitch,mirrorRoll;
...
Vector3d mirror[4],screen[4],mirrorNormal, mirrorSavedCenter, mirrorCenter , screenCenter, screenProjectionOnMirror, planesIntersectionBase, planesIntersectionDirection, planesIntersecEnd;
