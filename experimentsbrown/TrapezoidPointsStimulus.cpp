...
void TrapezoidPointsStimulus::setNpoints(unsigned int value)
{
    this->nPoints = value;
}

void TrapezoidPointsStimulus::setHeightNear(double value)
{
    heightNear = value;
}

void TrapezoidPointsStimulus::setHeightFar(double value)
{
    heightFar = value;
}

void TrapezoidPointsStimulus::setWNear(double value)
{
    wNear = value;
}

void TrapezoidPointsStimulus::setWFar(double value)
{
    wFar = value;
}

void TrapezoidPointsStimulus::setZNear(double value)
{
    zNear = value;
}

void TrapezoidPointsStimulus::setZFar(double value)
{
    zFar = value;
}

TrapezoidPointsStimulus::TrapezoidPointsStimulus() :  nPoints(0)
{
}
...
TrapezoidPointsStimulus::~TrapezoidPointsStimulus()
{
}

double TrapezoidPointsStimulus::quadrilateralArea(const Vector3d &P0, const Vector3d &P1, const Vector3d &P2, const Vector3d &P3)
{
...
PointsRand TrapezoidPointsStimulus::pointsInQuadrilateral(const Vector3d &P0,const Vector3d &P1,const Vector3d &P2,const Vector3d &P3, double density)
{
    PointsRand points;
    vector<Vector3d> pp;
    pp.push_back(P0);
...
void TrapezoidPointsStimulus::setDensity(double value)
{
    this->pointsDensity = value;
}

void TrapezoidPointsStimulus::setCenter(const Vector3d &c)
{
    this->center << c;
}
...
**/
void TrapezoidPointsStimulus::compute()
{
    ...
    /**
        ...
        \                  /
         \                /
          \5____________6/
    **/
    P[0] << -wFar/2,  -heightFar/2, zFar;
    P[1] << -wNear/2, -heightNear/2, zNear;
    P[2] <<  wNear/2, -heightNear/2, zNear;
    P[3] <<  wFar/2,  -heightFar/2, zFar;

    P[4] << -wFar/2,  heightFar/2, zFar;
    P[5] << -wNear/2, heightNear/2, zNear;
    P[6] <<  wNear/2, heightNear/2, zNear;
    P[7] <<  wFar/2,  heightFar/2, zFar;
...
Vector3d *TrapezoidPointsStimulus::getVertices()
{
    return this->P;
}
