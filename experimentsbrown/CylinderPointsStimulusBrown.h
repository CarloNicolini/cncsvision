...
/**
*       \class CylinderPointsStimulusBrown
*       \ingroup Stimulus
...
*       A CylinderPointsStimulusBrown is a set of points that stay on a cylindrical surface defined by width, radius, height, and aperture.
**/

class CylinderPointsStimulusBrown : public PointwiseStimulus
{
public:
   double height, startAngle, endAngle, radius, diameterX,diameterZ, test;

   CylinderPointsStimulusBrown();
   ~CylinderPointsStimulusBrown();
