...
string experiment_directory = "S:/Domini-ShapeLab/Claire/Fall14/";

// paramters file directory and name
string parametersFile_directory = experiment_directory + "parametersClaireHandOcclusionTrialFall14.txt";
