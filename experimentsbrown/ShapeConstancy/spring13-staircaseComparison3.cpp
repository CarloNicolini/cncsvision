...
void drawStimulus()
{
	...
	if(part == 1)
		...
		{
			drawTrial(secondD); // draw second triple of rods
			if(moveToPartVIII)
				part += 1;
		} else if (part == 8)
		{
...
void initStreams()
{
	...
	parametersFile.open("C:/workspace/cncsvisioncmake/experimentsbrown/parameters/parametersstaircaseComparison3.txt");
	...
	string markersFileName  = "C:/Users/visionlab/Dropbox/Shape Lab Shared/Carlo/spring13-pointingEquilateralTriangle/Staircase/Comparison3/staircaseComparison3_markersFile_" + subjectName + ".txt";
    string responseFileName =  "C:/Users/visionlab/Dropbox/Shape Lab Shared/Carlo/spring13-pointingEquilateralTriangle/Staircase/Comparison3/staircaseComparison3_"   + subjectName + ".txt";
