...
static const int CUBEMODE=3;
int trialMode = SURFACES;
int trialNumber = 0;
...
bool checkHandAtStart = false, fingersShown=true, training=true, started=false;
...
void drawStimulus()
{
	...
	if(!pause)
	{
		...
		{
			drawTrial(35); // draw first triple of rods
			if(moveToPartIV)
				part += 1;
		} else if (part == 4)
		{
