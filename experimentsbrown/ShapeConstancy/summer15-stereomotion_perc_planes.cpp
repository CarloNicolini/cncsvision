...
// stimuli
StimulusDrawer boxLeftDrawer, boxRightDrawer, stereocheckDrawer[4], rodMiddleDrawer, fixCrossDrawer[2];
BoxNoiseStimulus boxLeft, boxRight, stereocheck[4], rodMiddle, fixCross[2];
...
#ifndef SIMULATION
string experiment_directory = "S:/Domini-ShapeLab/carlo/2014-2015/stereomotion_planes/";
//string experiment_directory = "C:/Users/visionlab/Desktop/";
#else
string experiment_directory = "/media/shapelab/Domini-ShapeLab/carlo/2014-2015/stereomotion_planes/";
#endif

// paramters file directory and name
string parametersFile_directory = experiment_directory + "parameters_stereomotion_perc_planes.txt";

// response file name
string responseFile_name = "summer15-stereomotion_perc_planes_";
