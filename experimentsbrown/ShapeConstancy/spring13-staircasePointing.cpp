...
void drawStimulus()
{
    ...
    if(frontRodShown && index.z() < handZpos + 30.0)
	{
		// Front rod
		glPushMatrix();
...
void initStreams()
{
	...
	parametersFile.open("C:/workspace/cncsvisioncmake/experimentsbrown/parameters/parametersstaircasePointing.txt");
	...
	string markersFileName  = "staircasePointing_markersFile_" + subjectName + ".txt";
    string responseFileName =  "staircasePointing_"   + subjectName + ".txt";
