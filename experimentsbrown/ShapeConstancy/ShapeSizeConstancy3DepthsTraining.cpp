...
int yMouseCoord = 0;
// square measures
double edge = 0.0, dedge = 0, jitterX = 0.0, xedge = 20.0, zedge = 60.0, jitter = 0.0;
Timer timer;
Timer globalTimer;
...
void initGLVariables()
{
	...
	for (int i=0; i<3; i++)
	{
		...
		cylinder[i].setRadiusAndHeight(xedge,zedge); // raggio (mm) altezza (mm)
...
void initStreams()
{
	...
	parametersFile.open("../parametersFiles/parametersShapeSizeConstancy3DepthsTraining.txt");
