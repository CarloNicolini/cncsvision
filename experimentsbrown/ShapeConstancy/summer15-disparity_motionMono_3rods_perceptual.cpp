...
// stimuli
StimulusDrawer stimDrawer[3], boxPedestalDrawer, boxStimulusDrawer;
...
void draw_three_rods_motion_mono();

/*************************** EXPERIMENT SPECS ****************************/

// experiment directory
#ifndef SIMULATION
string experiment_directory = "S:/Domini-ShapeLab/carlo/2014-2015/disparity_motionMono_3rods_perceptual/";
//string experiment_directory = "C:/Users/visionlab/Desktop/";
#else
string experiment_directory = "/media/shapelab/Domini-ShapeLab/carlo/2014-2015/disparity_motionMono_3rods_perceptual/";
#endif

// paramters file directory and name
string parametersFile_directory = experiment_directory + "parameters_disparity_motionMono_3rods_perceptual.txt";

// response file name
string responseFile_name = "summer15-disparity_motionMono_3rods_perceptual_";
	...
	if ( isStimulusDrawn )
	{
		if (timer.getElapsedTimeInMilliSec() < trial_duration)
		{
			if (first_stimulus == "pedestal")
			{
				...
				{
					IOD = 0.0;
					draw_three_rods_motion_mono(depth_pedestal);
				}
			...
			} else
			{
				...
				{
					IOD = 0.0;
					draw_three_rods_motion_mono(depth_stimulus);		
				}
			}
		} 
...
void initVariables()
{
	...
	dominant_eye = parameters.find("dominant_eye");
}
