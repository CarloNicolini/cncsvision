...
void initStreams()
{
	...
	string dirName  = "C:/Users/visionlab/Google Drive/DATA/Evan-haptic/oneStim/" + subjectName;
	mkdir(dirName.c_str());

	// Principal streams file
    string responseFileName =  "C:/Users/visionlab/Google Drive/DATA/Evan-haptic/oneStim/" + parameters.find("SubjectName") + "/evan-haptic_" + subjectName + ".txt";
