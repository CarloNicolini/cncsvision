...
// stimuli
StimulusDrawer boxLeftDrawer, boxRightDrawer, stereocheckDrawer[4], rodMiddleDrawer, boxOblique_pedestalDrawer, boxOblique_stimulusDrawer, fixCrossDrawer[2];
BoxNoiseStimulus boxLeft, boxRight, stereocheck[4], rodMiddle, boxOblique_stimulus, boxOblique_pedestal, fixCross[2];
...
void draw_two_planes_stereo(double deltaz)
{
	...
	// Front left
	glPushMatrix();
	glTranslated(-(10.0 + obl_length/2), 0, deltaz/2);
	boxLeftDrawer.draw();
	glPopMatrix();
