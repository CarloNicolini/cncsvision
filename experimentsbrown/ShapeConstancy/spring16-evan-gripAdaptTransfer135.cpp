...
string experiment_directory = "S:/Domini-ShapeLab/evan/spring16-gripAdaptTransfer135/";
// paramters file directory and name
string parametersFile_directory = experiment_directory + "spring16-gripAdaptTransfer135_parameters.txt";
// summary file headers
string trialFile_headers = "subjName\ttrialN\tattempt\tobjId\tobjHeight\tyPosn\tperturbation\tframeN\tfingersOccluded\ttime\tdistanceToObject\treachedObject\tindexXraw\tindexYraw\tindexZraw\tthumbXraw\tthumbYraw\tthumbZraw\tGA\ttargetX\ttargetY\ttargetZ";
/*************************** FUNCTIONS ***********************************/
...
void initTrial()
{
	...
	if(!practice){
		...
		moveObjectAbsolute(moveTo,centercal,5000);
		// turn the stepper
