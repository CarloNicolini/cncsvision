...
bool handAtStart = true, isStimulusDrawn=false;
...
void initStreams()
{
	...
	parametersFile.open("C:/workspace/cncsvisioncmake/experimentsbrown/parameters/parametersstaircaseAdjustment2.txt");
	...
	string markersFileName  = "C:/Users/visionlab/Dropbox/Shape Lab Shared/Carlo/spring13-pointingEquilateralTriangle/Staircase/twoBlocks2/staircaseAdjustment2_markersFile_" + subjectName + ".txt";
    string responseFileName =  "C:/Users/visionlab/Dropbox/Shape Lab Shared/Carlo/spring13-pointingEquilateralTriangle/Staircase/twoBlocks2/staircaseAdjustment2_"   + subjectName + ".txt";
...
void mouseFunc(int button, int state, int x, int y)
{
	...
	{
		 if(state==GLUT_DOWN && moveToPartIV)
		 {
			responsekey=4;
			if ( trial.isEmpty() )
			exit(0);
