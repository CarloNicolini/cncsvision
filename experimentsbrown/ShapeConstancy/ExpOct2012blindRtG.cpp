...
*/			// Central rod on focal plane
				...
				stimDrawer[2].draw();
				glPopMatrix();
		} else if (stimTimer.getElapsedTimeInMilliSec() > str2num<int>(parameters.find("TestStimulusDuration")) && stimTimer.getElapsedTimeInMilliSec() < str2num<int>(parameters.find("TrialDuration"))) 
		{
