...
void drawFingers(double offsetZ)
{
	...
	if(thumbObjectDistance >= (trial.getCurrent()["RelDepthObj"]/2) + offsetZ && !thumbDisappeared)
	{
		glPushMatrix();
		glLoadIdentity();
...
void initTrial()
{
	...
	trialFile << fixed << "subjName\ttrialN\ttime\tframeN\tindexXraw\tindexYraw\tindexZraw\tthumbXraw\tthumbYraw\tthumbZraw\teyeRXraw\teyeRYraw\teyeRZraw\teyeLXraw\teyeLYraw\teyeLZraw\tfingersOccluded\tindexDisappeared\tthumbDisappeared\toffset\tglobalTime" << endl;
...
void initStreams()
{
	...
	parametersFile.open("C:/workspace/cncsvisioncmake/experimentsbrown/parameters/parametersClaireHandOcclusionTrial14.txt");
	...
	responseFile << fixed << "subjName\tIOD\ttrialN\tRelDepthObj\tAbsDepth\toffset\ttrialDuration" << endl;
