...
bool direction_motion2 = 0.0;
double theta_pedestal = 0.0, theta_stimulus = 0.0;
...
string parametersFile_directory = experiment_directory + "parameters_3Dcues-paraboloid_thetaStaircase_perc.txt";

// response file name
string responseFile_name = "summer15-3Dcues-paraboloid_thetaStaircase_perc_";
...
/*
void draw_fixation_rod(double eye)
{
	glColor3fv(glWhite);
	glBegin(GL_QUADS);
	glVertex3f(-size/2, -size/2, -deltaz);
