...
string parametersFile_directory = experiment_directory + "parameters_3Dcues-wedge_perc.txt";

// response file name
string responseFile_name = "summer15-3Dcues-wedge_perc_";

// summary file headers
string responseFile_headers = "subjName\tIOD\ttrialN\tAbsDepth\tobjheight\tobjtheta\tdepth_pedestal\tdepth_stimulus\tupper_object\tlower_object\tdepth_cue_pedestal\tdepth_cue_stimulus\tstairID\tstairState\tstairReversals\tstairAscending\tstairStepsDone\tresponsekey\tresp\tDepthCue\ttrialDuration";
...
void draw_fixation_rod(int eye)
{
		// upper left 
		glColor3fv(glRed);
		glBegin(GL_QUADS);
