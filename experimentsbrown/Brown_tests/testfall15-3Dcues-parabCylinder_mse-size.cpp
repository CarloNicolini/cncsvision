...
string parametersFile_directory = experiment_directory + "parameters_3Dcues-parabCylinder_mse-size.txt";

// response file name
string responseFile_name = "fall15-3Dcues-parabCylinder_mse-size_";
...
// markers file name
string markersFile_name = "fall15-3Dcues-parabCylinder_mse-size_";
