...
string parametersFile_directory = experiment_directory + "parameters_perc_action_perc-grasp_fixdist.txt";
...
// response file name
string grasp_responseFile_name = "spring16-percactperc_grasp_fixdist_";
