...
string parametersFile_directory = experiment_directory + "parameters_3Dcues-parabCylinder_mse-texture.txt";

// response file name
string responseFile_name = "fall15-3Dcues-parabCylinder_mse-texture_";

// summary file headers
string responseFile_headers = "subjName\tIOD\ttrialN\trepetitions\tRelDepthObj\tdepth_cue\tAbsDepth\tMSE\ttrialDuration\tgood_trial";

// markers file name
string markersFile_name = "fall15-3Dcues-parabCylinder_mse-texture_";
