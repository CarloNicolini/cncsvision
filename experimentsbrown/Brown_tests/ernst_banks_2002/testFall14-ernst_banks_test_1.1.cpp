...
string parametersFile_directory = experiment_directory + "parameters_fall14ErnstBanks_test1.1.txt";

// response file name
string responseFile_name = "fall14-1.1_ernstbanksreplica_";
...
string summaryFile_headers = "subjName\tIOD\ttrialN\tAbsDepth\tbar_height\tnominal_stimulus\tfirst_stimulus\tsecond_stimulus\tnoise_level\tresponsekey";
...
//		double JND = rand_normal(0.0, str2num<double>(parameters.find("JND")));
		double JND = rand_normal(0.0, sign[first_interval] * str2num<double>(parameters.find("JND")));
*/
		...
		ENG  eng;
		DIST dist(0,str2num<double>(parameters.find("JND")));
		GEN  gen(eng,dist);
