...
string parametersFile_directory = "/home/carlo/workspace/cncsvisioncmake/experimentsbrown/parameters/parameters_fall14ErnstBanks_test1.txt";
...
int main(int argc, char*argv[])
{
	...
	initRendering();
	initVariables();
	buildErnstBanksSpheres(stimulus_height, stim_fluffiness);
