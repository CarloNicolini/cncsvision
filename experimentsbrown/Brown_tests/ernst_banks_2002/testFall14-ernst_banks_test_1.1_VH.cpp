...
string parametersFile_directory = experiment_directory + "parameters_fall14ErnstBanks_test1.1_VH-test.txt";

// response file name
string responseFile_name = "fall14-1.1_ernstbanksreplica_VH_";

// response file headers
string responseFile_headers = "subjName\tIOD\ttrialN\ttime\tframeN\tindexXraw\tindexYraw\tindexZraw\tthumbXraw\tthumbYraw\tthumbZraw\teyeRXraw\teyeRYraw\teyeRZraw\teyeLXraw\teyeLYraw\teyeLZraw\tfingersOccluded\tframesOccluded\tAbsDepth\tbar_height\tfirst_visual_stimulus\tsecond_visual_stimulus\thaptic_height\tresponsekey";

// summary file headers
string summaryFile_headers = "subjName\tIOD\ttrialN\tAbsDepth\tbar_height\tnominal_stimulus\tfirst_stimulus\tsecond_stimulus\tnoise_level\thaptic_standard\tvisual_standard\tresponsekey";
...
void drawInfo()
{
	if ( visibleInfo )
	{
		...
		if(interoculardistance>45.0)
		{
			...
			text.draw("Index y = " +stringify<double>(ind.y()));
