...
#endif
*/
//string	experiment_directory  = "C:/cncsvisiondata/parametersFiles/Campagnoli/";
string	experiment_directory  = "/home/carlo/workspace/cncsvisioncmake/build/";
...
void initStreams()
{
    ...
    parametersFile.open("parameters_3Dcues-paraboloid_perc.txt");
...
void initVariables()
{
    ...
    continuous_line = parameters.find("continuous_line").find('y') != std::string::npos;
...
void initOptotrak()
{
    ...
    if ( optotrak.init(LastAlignedFile, OPTO_NUM_MARKERS+2, OPTO_FRAMERATE, OPTO_MARKER_FREQ, OPTO_DUTY_CYCLE,OPTO_VOLTAGE) != 0)
    {
