...
#ifndef SIMULATION
string experiment_directory = "S:/Domini-ShapeLab/carlo/2016/perc_action_perc_fixdist/";
//string experiment_directory = "C:/Users/visionlab/Desktop/";
#else
string experiment_directory = "/media/shapelab/Domini-ShapeLab/carlo/2016/perc_action_perc_fixdist/";
#endif

// paramters file directory and name
string parametersFile_directory = experiment_directory + "parameters_perc_action_perc-mse_fixdist.txt";

// response file name
string perc_responseFile_name = "spring16-percactperc_perc_fixdist_";
...
// response file name
string grasp_responseFile_name = "spring16-percactperc_mse_fixdist_";

// response file headers
string grasp_responseFile_headers = "subjName\tIOD\ttrialN\tAbsDepth\tRelDepthObj\ttrialDuration\tvisual_feedback\tgood_trial\ttraining\tMSE";

// markers file name
string markersFile_name = "spring16-percactperc_fixdist_";
