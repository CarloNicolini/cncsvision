...
#ifndef SIMULATION
string experiment_directory = "S:/Domini-ShapeLab/carlo/2014-2015/disparity_motion_planes_perceptual/";
//string experiment_directory = "C:/Users/visionlab/Desktop/";
#else
string experiment_directory = "/media/shapelab/Domini-ShapeLab/carlo/2014-2015/disparity_motion_planes_perceptual/";
#endif

// paramters file directory and name
string parametersFile_directory = experiment_directory + "parameters_disparity_motion_planes_perceptual.txt";

// response file name
string responseFile_name = "summer15-disparity_motion_planes_perceptual_";
