...
// stimuli
StimulusDrawer boxLeftDrawer, boxRightDrawer, stereocheckDrawer[4], rodMiddleDrawer;
BoxNoiseStimulus boxLeft, boxRight, stereocheck[4], rodMiddle;
