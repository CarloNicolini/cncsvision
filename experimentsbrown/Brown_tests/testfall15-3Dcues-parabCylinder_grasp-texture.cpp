...
bool areFingersDrawn=false, isIndexDrawn=true;
...
// char
char* model_name = NULL;   /* name of the obect file */
...
void drawParabolicCylinder_texture();
...
#ifndef SIMULATION
string experiment_directory = "S:/Domini-ShapeLab/carlo/2014-2015/3Dcues-parabolicCylinder/texture/";
//string experiment_directory = "C:/Users/visionlab/Desktop/";
#else
string experiment_directory = "/media/shapelab/Domini-ShapeLab/carlo/2014-2015/3Dcues-parabolicCylinder/texture/";
#endif

// parameters file directory and name
string parametersFile_directory = experiment_directory + "parameters_3Dcues-parabCylinder_grasp-texture.txt";

// response file name
string responseFile_name = "fall15-3Dcues-parabCylinder_grasp-texture_";

// summary file headers
string responseFile_headers = "subjName\tIOD\ttrialN\trepetitions\tRelDepthObj\tdepth_cue\tAbsDepth\ttrialDuration\tgood_trial\tgrasp";

// markers file name
string markersFile_name = "fall15-3Dcues-parabCylinder_grasp-texture_";
...
void initTrial()
{
		...
		//Vector3d object_position(0.0,object_reset_position.y(),objdistance);
		...
		if(grasp == "s")
		{
			...
			paraboloidtheta = atan(objwidth/current_depth);

			// set the phidgets
			//stepper_rotate(rotTable, paraboloidtheta * 180.0 / M_PI);
		}
		...
		if(current_depth == 20.0)
			model_name = "parabolic_cylinder_20_grid.obj";
		if(current_depth == 30.0)
			model_name = "parabolic_cylinder_30_grid.obj";
		if(current_depth == 40.0)
			model_name = "parabolic_cylinder_40_grid.obj";
		if(current_depth == 50.0)
			model_name = "parabolic_cylinder_50_grid.obj";
		current_model = load_obj(model_name, model);
...
void online_trial()
{
	if(fingerCalibrationDone==4)
	{
		...
		if(grasp == "d")
		{
			index_behind_the_stimulus = abs(ind.x()) < objwidth;
