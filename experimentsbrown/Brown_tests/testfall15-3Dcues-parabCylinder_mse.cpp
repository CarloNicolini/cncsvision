...
string parametersFile_directory = experiment_directory + "parameters_3Dcues-parabCylinder_mse.txt";

// response file name
string responseFile_name = "fall15-3Dcues-parabCylinder_mse_";
...
// markers file name
string markersFile_name = "fall15-3Dcues-parabCylinder_mse_";
