...
/**
*       \class ExtrudedTrapezePointsStimulus
*       \ingroup Stimulus
*       Defines a visual stimulus abstracting out the OpenGL visualization and only keeping the basic informations
*       A ExtrudedTrapezePointsStimulus is a set of points, on two planes that make two trapezes. The trapeze base is at 0 the back is at -z.
**/

class ExtrudedTrapezePointsStimulus : public PointwiseStimulus
{
public:
