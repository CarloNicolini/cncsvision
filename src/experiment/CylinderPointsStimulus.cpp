...
**/
CylinderPointsStimulus::CylinderPointsStimulus() : PointwiseStimulus()
{  radius=1.0;
   height=1.0;
   fluffiness=1.0;
   startAngle = 0.0;
...
* Destructor
**/
CylinderPointsStimulus::~CylinderPointsStimulus()
{
}
/**
...
**/
void CylinderPointsStimulus::setRadiusAndHeight(double r, double h)
{  //radius = r;
   //height = h;
...
* \param h height of the cylinder
**/
void CylinderPointsStimulus::setRadiusAndHeight(double diamX, double diamZ, double h)
{
	diameterX=diamX;
	diameterZ=diamZ;
	height=h;
...
**/
void CylinderPointsStimulus::compute()
{
...
/**
 * @brief CylinderPointsStimulus::getDiameterX
 * @return
 */
double CylinderPointsStimulus::getDiameterX() const
{
    return this->diameterX;
}

/**
 * @brief CylinderPointsStimulus::getDiameterZ
 * @return
 */
double CylinderPointsStimulus::getDiameterZ() const
{
    return this->diameterZ;
}

/**
 * @brief CylinderPointsStimulus::getHeight
 * @return
 */
double CylinderPointsStimulus::getHeight() const
{
    return this->height;
}
