...
#ifndef _ELLIPSOIDPOINTS_STIMULUS_H
#define _ELLIPSOIDPOINTS_STIMULUS_H
...
class EllipsoidPointsStimulus : public PointwiseStimulus
{
private:
    double heightY;
    double startAngle;
...
public:
   EllipsoidPointsStimulus();
   ~EllipsoidPointsStimulus();

   void setAxesAndHeight(double xAxis, double zAxis, double heightY);
   ...
   int getStimulusType()
   {  return Stimulus::StimEllipsoidPointwise ;
   };
   int isPointwise()
   {  return 1;
   };
