...
{  "[Error 00] GLSL is not available!",
   "[Error 01] GLSL Not a valid program object!",
   "[Error 02] GLSL Not a valid object!",
   "[Error 03] GLSL Out of memory!",
   "[Error 04] GLSL Unknown compiler!",
   "[Error 05] GLSL Linker log is not available!",
   "[Error 06] GLSL Compiler log is not available!",
   "[Empty] GLSL"
};
