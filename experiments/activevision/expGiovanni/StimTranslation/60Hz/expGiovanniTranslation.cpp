...
void initStreams()
{
	string parametersFileName = "parametersActiveTranslation.txt";
...
markers = optotrak.getAllMarkers();
	...
	//questo è il vecchio pezzo di codice per il movimento del piano, qui lo vogliamo solamente frontoparallelo
	switch ( (int) factors["Rotation"] )
	{
	case 2:
	{
