...
{   // Draw the stimulus ( red-dots plane )
	...
	transformation.matrix().topLeftCorner<3,3>() 
		= (AngleAxis<double>(eulerAngles.getYaw(), Vector3d::UnitY())*AngleAxis<double>(eulerAngles.getPitch(), Vector3d::UnitX())).toRotationMatrix();
