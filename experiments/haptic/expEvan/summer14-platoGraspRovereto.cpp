...
void initTrial()
{
	...
	if (controlCondition){
	string trialFileName = "C:/Documents and Settings/Fulvio/My Documents/Google Drive/platoGraspRovereto/" + parameters.find("SubjectName") + "/" + parameters.find("SubjectName") + "_controlTrial_" + stringify<int>(controlTrial) + ".txt";
	...
	if (!controlCondition) {
	string trialFileName = "C:/Documents and Settings/Fulvio/My Documents/Google Drive/platoGraspRovereto/" + parameters.find("SubjectName") + "/" + parameters.find("SubjectName") + "_trial_" + stringify<int>(trialNumber) + ".txt";
	trialFile.open(trialFileName.c_str());
	trialFile << fixed << "subjName\ttrialN\ttime\tframeN\tindexX\tindexY\tindexZ\tthumbX\tthumbY\tthumbZ\tdistanceToObject\tfingersVisible\treachedObject" << endl;
	}
