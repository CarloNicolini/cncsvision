...
void initRendering()
{
    ...
    GLfloat lightPos[] = {0.0,200,focalDistance };
...
{
    shader = SM.loadfromFile((char*)"../../data/glslshaders/ReflectionMapLongLatOptotrak.vert", (char*)"../../data/glslshaders/ReflectionMapLongLatOptotrak.frag");
