...
int paramIndex=0;
/*
char *parametersFileNames[] ={"parametersRobertGrasping_v4_thumb_elliptic_training.txt",
"parametersRobertGrasping_v4_thumb_elliptic_Cong.txt", "parametersRobertGrasping_v4_thumb_elliptic_Incong.txt"
};
*/

char *parametersFileNames[] ={
	"C:/cncsvisiondata/parametersFiles/Robert/expGraspingV4/parametersRobertGrasping_v4_thumb_elliptic_training.txt",
	"C:/cncsvisiondata/parametersFiles/Robert/expGraspingV4/parametersRobertGrasping_v4_thumb_elliptic_Cong.txt",
	"C:/cncsvisiondata/parametersFiles/Robert/expGraspingV4/parametersRobertGrasping_v4_thumb_elliptic_Incong.txt"
};
    ...
    {   bool pretrialMode=trialMode;
        ...
        case 0:  //pre-test
        {
            ...
            {   beepTrial();
                ...
                initStimulus(testStimHeight,deltaXRods,factors.at("RelDepth"));
            ...
            {   trialMode = HANDONSTARTMODE;
                ...
                initStimulus(testStimHeight,adaptStimRadius*2,adaptStimRadius*2);
...
{   ifstream inputParameters;
    cerr << "Loading parameter file... ";
    inputParameters.open(parametersFileNames[paramIndex]);
	cerr << parametersFileNames[paramIndex] << " OK" << endl;
