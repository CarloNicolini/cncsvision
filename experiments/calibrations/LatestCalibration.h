...
extern double focalDistance = -418.5;
extern const double homeFocalDistance = -418.5;
// SCREEN_HEIGHT_SIZE is  SCREEN_WIDE_SIZE*SCREEN_HEIGHT/SCREEN_WIDTH to mantain proportions

extern const Eigen::Vector3d calibration( 338.0, 318.0, 393.0 ); //new relative to calibration 25 march february 2014
...
extern const double alignmentX =  5.00 ; //new relative to calibration 14 february 2014
extern const double alignmentY =  30.75; //new relative to calibration 14 May 2014
