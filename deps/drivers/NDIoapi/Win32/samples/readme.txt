...
sample5      - Simoultenous real-time data and spool data to file.
sample6      - Simoultenous real-time data and spool data to memory.
...
sample16     - Retrieve real-time Full Raw data using the default collection.
