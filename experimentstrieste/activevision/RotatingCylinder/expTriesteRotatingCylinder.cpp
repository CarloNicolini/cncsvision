...
void initializeOptotrakMonitor()
{
    ...
    TriesteMotorFunctions::homeMonitor(3500);
    TriesteMotorFunctions::homeObjectAsynchronous(3500);
    /*
...
void initProjectionScreen(double _focalDist)
{
    ...
    TriesteMotorFunctions::moveMonitorAbsolute(_focalDist,homeFocalDistance,3500);
}
