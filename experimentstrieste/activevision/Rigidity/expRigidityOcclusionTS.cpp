...
static const double focalDistance= baseFocalDistance-100.0; // la distanza totale media è baseFocalDistance-100.0 - obs_dist_from_origin; -100 è la distanza schermo
...
void initVariables()
{
    ...
    for (int i=0; i<2; i++)
    {
        ...
        redDotsPlane[i].setDimensions(str2num<double>(parameters.find("planeXdimension")),str2num<double>(parameters.find("planeYdimension")),0.01);
