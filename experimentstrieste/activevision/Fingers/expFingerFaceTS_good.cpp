...
int paramIndex=0;
char *parametersFileNames[] = {"parametersExpFingerFace_good.txt"};
...
void keyPressed()
{
    ...
    responseFile << fixed <<
                 ...
                 TimeInit << " " <<
                 globalTimer.getElapsedTimeInMilliSec()-TimeInit << " " <<
                 answer << endl;
}
    ...
    {   bool pretrialMode=trialMode;
        ...
        case 0:  //pre-test
        {
            ...
            {   trialMode = HANDONSTARTMODE;
                ...
                double zadaptmin = str2num<double>(parameters.find("AdaptZMin")) + str2num<double>(parameters.find("AdaptStimulusOffz"));
                double zadaptmax = str2num<double>(parameters.find("AdaptZMax")) + str2num<double>(parameters.find("AdaptStimulusOffz"));
...
{   trial.init(parameters);
    ...
    tex[0].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.75.bmp");
    tex[1].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.65.bmp");
    tex[2].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.55.bmp");
    tex[3].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.45.bmp");
    tex[4].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.35.bmp");
    tex[5].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe1_HtA_0.25.bmp");
    tex[6].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.75.bmp");
    tex[7].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.65.bmp");
    tex[8].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.55.bmp");
    tex[9].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.45.bmp");
    tex[10].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.35.bmp");
    tex[11].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe2_HtA_0.25.bmp");
    tex[12].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.25.bmp");
    tex[13].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.35.bmp");
    tex[14].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.45.bmp");
    tex[15].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.55.bmp");
    tex[16].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.65.bmp");
    tex[17].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe4_HtA_0.75.bmp");
    tex[18].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.75.bmp");
    tex[19].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.65.bmp");
    tex[20].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.55.bmp");
    tex[21].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.45.bmp");
    tex[22].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.35.bmp");
    tex[23].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Fe19_HtA_0.25.bmp");
    tex[24].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.75.bmp");
    tex[25].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.65.bmp");
    tex[26].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.55.bmp");
    tex[27].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.45.bmp");
    tex[28].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.35.bmp");
    tex[29].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma20_HtA_0.25.bmp");
    tex[30].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.75.bmp");
    tex[31].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.65.bmp");
    tex[32].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.55.bmp");
    tex[33].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.45.bmp");
    tex[34].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.35.bmp");
    tex[35].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma30_HtA_0.25.bmp");
    tex[36].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.25.bmp");
    tex[37].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.35.bmp");
    tex[38].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.45.bmp");
    tex[39].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.55.bmp");
    tex[40].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.65.bmp");
    tex[41].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma46_HtA_0.75.bmp");
    tex[42].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.75.bmp");
    tex[43].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.65.bmp");
    tex[44].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.55.bmp");
    tex[45].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.45.bmp");
    tex[46].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.35.bmp");
    tex[47].loadBMP("C:/cncsvisioncmake/data/textures/HtA/Ca_Ma71_HtA_0.25.bmp");
...
{   /*ifstream inputParameters;
    ...
    parameters.loadParameterFile("C:/cncsvisioncmake/build/Release/parametersExpFingerFace_good.txt");
    // WARNING:
...
void drawStimulus()
{
    if ( isDrawing )
    {
        ...
        if ( block.at("Phase") == 1 )
        {
            glPushMatrix();
            glLoadIdentity();
            glTranslated(visualRodCenter.x()+str2num<double>(parameters.find("AdaptStimulusOffx") ), visualRodCenter.y()+str2num<double>(parameters.find("AdaptStimulusOffy") ), visualRodCenter.z()-str2num<double>(parameters.find("AdaptStimulusOffz") )); ///// OFFSET STIMOLO VISIVO/MARKER 15
            stimDrawer[0].draw();
            glPopMatrix();
        }
        else
        {
            ...
            if ( block.at("Phase")!=1 && isDrawing==1 && parameters.find("Task") == "Perc" && globalTimer.getElapsedTimeInMilliSec()<800)
            {
                TimeInit=globalTimer.getElapsedTimeInMilliSec();
                //drawingTrialFrame<30){ //// Aggiunto
                if (globalTimer.getElapsedTimeInMilliSec()<400) {
            ...
            else
            {
                ...
                {
                    tex[(int)factors.at("Faces")].drawFrame(75,105,visualRodCenter.z());
                }
                else {
                    ////
                    glPushMatrix();
...
{   switch (key)
    ...
    case '4':
    {
        if ( ( fingerCalibrationDone==3 && headCalibrationDone==3 ) && (block.at("Phase")  != 1) && (parameters.find("Task") == "Perc") && (globalTimer.getElapsedTimeInMilliSec()>800))
        {
            // cerr << "tasto 4 " << endl;
...
// Write to file
    ...
    // outputfile << "Face: " << (int)factors.at("Faces") << endl;
    outputfile << "Response: " << answer << endl;
#endif
    frameTimer.start();
}
