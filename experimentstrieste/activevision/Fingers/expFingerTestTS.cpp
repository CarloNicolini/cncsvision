...
int paramIndex=0;
char *parametersFileNames[] = {"parametersExpFingerTrieste.txt"};
...
{   /*ifstream inputParameters;
    ...
    parameters.loadParameterFile("parametersExpFingerTrieste.txt");
    // WARNING:
...
int main(int argc, char*argv[])
{
    ...
    cerr << "::::DISCLAIMER::::\nThis experiment is the Trieste version of expRobertGrasping_v5_thumb_elliptic.cpp" << endl;
#endif
    randomizeStart();
